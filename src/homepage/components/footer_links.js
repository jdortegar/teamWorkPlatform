		...
		<div className = "row">
            ...
            <div className="col-md-2 col-md-offset-2">
                <div className="footer-nav">
                    	...
                    	<p><a href="#/" className="footer-link">App Directory</a></p>
            ...
            <div className="col-md-2">
                <div className="footer-nav">
                    	...
                    	<p><a href="#/" className="footer-link">Security</a></p>
                    	<p><a href="#/" className="footer-link">Term of Service</a></p>
                    	<p><a href="#/" className="footer-link">Policies</a></p>
