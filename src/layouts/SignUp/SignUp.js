      ...
      <Row type="flex" justify="center" align="middle" style={{ width: '100%' }}>
        <Col xs={{ span: 20 }} md={{ span: 12 }} lg={{ span: 8 }}>
          <div style={{ textAlign: 'center' }}>
            <img alt={String.t('signUp.logoAlt')} className="signup-logo" src="https://c2.staticflickr.com/4/3955/33078312014_f6f8c759db_o.png" />
            <h2>{String.t('signUp.companyName')}</h2>
          </div>
          <Switch>
