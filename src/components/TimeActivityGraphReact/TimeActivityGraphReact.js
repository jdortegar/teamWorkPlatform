...
class TimeActivityGraphReact extends Component {
  state = {
    xScale: null,
    yScale: null,
    zoomScale: 1,
...
TimeActivityGraphReact.propTypes = propTypes;
TimeActivityGraphReact.defaultProps = defaultProps;

export default TimeActivityGraphReact;
